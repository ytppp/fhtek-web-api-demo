...
export default {
  ...
  mounted() {
    if (this.trigger === Trigger.click) {
      this.$refs.triggerWrapper.addEventListener('click', this.handleClick)
    } else {
  ...
  beforeUnmount() {
    if (this.trigger === Trigger.click) {
      this.$refs.triggerWrapper.removeEventListener('click', this.handleClick)
    } else {
      this.$refs.triggerWrapper.removeEventListener('mouseenter', this.onShow)
      this.$refs.triggerWrapper.removeEventListener('mouseleave', this.onClose)
    }
  },
}
</script>
