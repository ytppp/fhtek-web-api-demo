...
const getLanSpeedData = () => {
  getLanSpeed().then(({ data }) => {
    ...
    const thisTableData = [
      {
        [Lan1]: '10half', // items.find((item) => item.ifname === Lan1).speed,
        [Lan2]: '100half', // items.find((item) => item.ifname === Lan2).speed,
        [Lan3]: '10half', // items.find((item) => item.ifname === Lan3).speed
        [Lan4]: '10half', // items.find((item) => item.ifname === Lan4).speed
      },
    ]
